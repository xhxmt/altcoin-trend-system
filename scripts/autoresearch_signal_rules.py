...
def candidate_rules(iterations: int) -> list[RuleConfig]:
    seeds = [
        (0.01, 0.02, 0.0, 0.03, 0.0, 1.5, 0.0, 0.70, 0.60, 0.00, False, 0.0),
        (0.02, 0.03, 0.0, 0.04, 0.0, 2.0, 0.0, 0.75, 0.65, 0.00, False, 0.0),
        (0.03, 0.05, 0.0, 0.06, 0.0, 2.5, 0.0, 0.80, 0.70, 0.00, False, 0.0),
        (0.04, 0.07, 0.0, 0.08, 0.0, 3.0, 0.0, 0.85, 0.75, 0.00, False, 0.0),
        (0.05, 0.09, 0.0, 0.10, 0.0, 4.0, 0.0, 0.90, 0.80, 0.00, False, 0.0),
        (0.02, 0.04, 0.0, 0.05, 0.0, 3.0, 0.0, 0.85, 0.80, 0.00, True, 0.0),
        (0.03, 0.06, 0.0, 0.08, 0.0, 2.0, 0.0, 0.90, 0.85, 0.00, True, 0.0),
        (0.01, 0.03, 0.0, 0.06, 0.0, 4.0, 0.0, 0.95, 0.90, 0.00, False, 0.0),
        (0.04, 0.04, 0.0, 0.04, 0.0, 5.0, 0.0, 0.75, 0.70, 0.00, True, 0.0),
        (0.00, 0.08, 0.0, 0.12, 0.0, 2.5, 0.0, 0.95, 0.85, 0.00, True, 0.0),
        (0.06, 0.08, 0.0, 0.12, 0.0, 5.5, 0.0, 0.97, 0.97, 0.80, True, 0.0),
        (0.07, 0.08, 0.0, 0.50, 0.0, 5.0, 10.0, 0.97, 0.98, 0.80, True, 0.0),
        (0.18, 0.08, 0.0, 0.50, 0.0, 5.0, 10.0, 0.97, 0.98, 0.80, True, 0.0),
        (0.12, 0.38, 0.0, 0.50, 0.0, 5.0, 10.0, 0.97, 0.98, 0.80, True, 0.0),
        (0.12, 0.38, 1.10, 0.50, 0.65, 5.0, 10.0, 0.999, 0.988, 0.80, True, 0.40),
    ]
...
def evaluate_rule(frame: pd.DataFrame, rule: RuleConfig, target_return: float) -> dict[str, Any]:
    ...
    if rule.max_return_1h > 0:
        mask &= frame["return_1h"] <= rule.max_return_1h
