...
def test_ultra_high_conviction_candidate_accepts_slightly_earlier_30d_strength_when_other_filters_are_strong():
    assert is_ultra_high_conviction_candidate(_ultra_row(return_30d_percentile=0.781)) is True
