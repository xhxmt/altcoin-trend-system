...
def test_ultra_high_conviction_candidate_accepts_slightly_earlier_7d_strength_when_other_filters_are_strong():
...
def test_ultra_high_conviction_candidate_rejects_overextended_or_unconfirmed_rows():
    ...
    assert is_ultra_high_conviction_candidate(_ultra_row(return_7d_percentile=0.979)) is False
