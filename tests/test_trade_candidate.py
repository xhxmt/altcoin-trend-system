...
def test_ultra_high_conviction_candidate_accepts_earlier_30d_context_when_other_filters_are_strong():
    assert (
        is_ultra_high_conviction_candidate(
            _ultra_row(
                return_1h_pct=29.0,
                return_24h_pct=118.0,
                return_30d_pct=55.1,
...
def test_ultra_high_conviction_candidate_rejects_overextended_or_unconfirmed_rows():
    ...
    assert is_ultra_high_conviction_candidate(_ultra_row(return_24h_pct=130.1)) is False
    assert is_ultra_high_conviction_candidate(_ultra_row(return_30d_pct=54.9)) is False
    assert is_ultra_high_conviction_candidate(_ultra_row(return_30d_pct=140.1)) is False
